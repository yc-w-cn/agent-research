...
**相关资源必须真实相关，严禁编撰相关性。只有在原始内容（论文、代码仓库、资源页面）中明确提到的资源才能添加到 related 字段。**

验证方法：
- 检查论文的参考文献部分
- 检查 GitHub 仓库的 README 文档
- 检查资源页面的相关链接部分
- 确认原始内容中确实提到了该资源

注意事项：
- 不能因为主题相关就添加到 related 字段
- 不能添加个人推荐的资源，除非原始内容中明确提到
- 如果原始内容中没有提到任何相关资源，应将 related 字段留空或删除
- 保持资源的真实性和可追溯性
